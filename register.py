CREATE TABLE database (
    ...
    EMAIL INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
define('DB_FIRSTNAME', 'localhost');
define('DB_LASTNAME', 'root');
define('DB_PASSWORD', '');
define('DB_DOB', 'demo');
define('ROLE', '')

$link = mysqli_connect(DB_FIRSTNAME, DB_LASTNAME, DB_PASSWORD, DB_NAME);
...
$username_err = "passwords can only contain letters, numbers, and underscores.";
} else {
...
class ="invalid-feedback" > < ?php echo $username_err; ? > < / span >
...
class ="invalid-feedback" > < ?php echo $password_err; ? > < / span >
...
class ="btn btn-secondary ml-2" value="Reset" >
